  ...
  return (
    <main className='h-[100vh] content w-full min-h-screen text-white flex flex-col xl:p-0'>
      ...
      <header className="my-nav w-full fixed top-0 left-0 z-[1000] transition-all duration-[.6s]">
        <nav className="bg-transparent z-[1000] mx-auto max-w-[82rem] flex justify-between py-5 items-center top-0 left-0 w-full transition duration-[.6s] px-[1.5rem] md:px-[1rem] lg:px-[3rem] xl:px-0">
      ...
      {/* Hero Section */}
      <section className='relative w-full lg:max-w-[82rem] flex flex-col mx-auto h-[100vh] mt-[4.5rem] lg:mt-[9rem] px-[1.5rem] md:px-[2.1rem] lg:px-[3rem] xl:px-0'>
        ...
        <div className='flex flex-col lg:flex-row xl:gap-[3.8rem] xl:mt-12'>
          {/* Text Content */}
          <div className='flex flex-col lg:items-start lg:space-y-6 tracking-wide transform translate-y-[4rem] xl:translate-y-[7rem]'>
            ...
            <div className='flex flex-col lg:gap-4'>
              ...
              <div className="mb-4 lg:mb-0 mt-[-1rem] xl:mt-[-1.5rem] typewriter text-[38px] md:text-[45px] xl:text-[65px] text-[#0788FF] uppercase font-semibold" data-aos="fade-right" data-aos-duration="1500" data-aos-delay="1200">I'm a <span className="typewriter-text">{displayedText}</span>{showCursor && <label htmlFor="" className='blink'>|</label>}</div>
            </div>
            <p className="text-white text-[18px] font-[500]  lg:w-[30rem] xl:w-[37rem] leading-7" data-aos="flip-down" data-aos-duration="1500" data-aos-delay="1400">
              ...
              <div className="mt-8 lg:mt-0 flex flex-col md:flex-row gap-6 items-center" data-aos="zoom-out" data-aos-duration="1500" data-aos-delay="1600">
              <button className="w-full text-center justify-center md:text-start uppercase flex md:justify-between items-center bg-blue-500 text-[white] font-[500] px-[28px] py-[14px] rounded-full border-[2px] border-blue-500 hover:bg-black hover:border-white transition-all duration-[.35s] ease-linear">
              ...
              <div className="flex space-x-2">
                <a href="#" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="1800" className="social-icon bg-blue-600 p-3 rounded-full hover:bg-blue-700 border-2 border-white">
                  {/* Facebook Icon */}
                ...
                <a href="#" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="1900" className="social-icon bg-pink-600 p-3 rounded-full hover:bg-pink-700 border-2 border-white">
                  {/* Dribbble Icon */}
                ...
                <a href="#" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="2000" className="social-icon bg-[#1275b1] p-3 rounded-full hover:bg-blue-500 border-2 border-white">
                  {/* LinkedIn Icon */}
          ...
          {/* Image */}
          <div className="pr-7 md:px-0" data-aos="zoom-out" data-aos-duration="3000">
            <div className="md:w-[590px] md:h-[580px] lg:w-[400px] lg:h-[400px] xl:w-[618px] xl:h-[600px] image-container mt-36 md:mt-44 lg:mt-5 xl:mt-12 ml-8 rounded-full overflow-hidden box-shadow ">
              <Image
                src="/images/my-profile.png"
                alt="Folagbade Olowofela"
                width={618}
                height={600}
                className="w-auto h-auto md:w-[590px] md:h-[580px] lg:w-auto lg:h-auto xl:w-[618px] xl:h-[600px] rounded-full shadow-lg"
              />
            </div>
          </div>
        </div>
