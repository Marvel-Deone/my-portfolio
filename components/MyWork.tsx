        ...
        <section className='bg-gradient-to-r from-[#062d4d] from-50% to-[#051a2f] w-full flex flex-col mx-auto py-[6rem] px-[1.5rem] md:px-[2.1rem] lg:px-[4rem] 2xl:px-0'>
            <div className='w-full lg:max-w-[82rem] flex flex-col mx-auto gap-10'>
                <div className='flex flex-col lg:gap-4'>
                    <span data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200" className="font-[500] mb-2 lg:mb-0 inline whitespace-nowrap text-white w-auto px-[12px] py-[4px] rounded-[4px] uppercase tracking-[0.3rem] text-[16px] bg-[#063560]" style={{
