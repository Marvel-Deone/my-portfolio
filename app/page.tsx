...
const Home = () => {
  ...
  return (
    <main className='content w-full min-h-screen text-white flex flex-col xl:p-0'>
      ...
      {/* Brand Section */}
      <section data-aos="fade-up" data-aos-duration="1200" data-aos-delay="500" className='bg-gradient-to-r from-[#052442] from-40% to-[#051a2f] w-full flex flex-col mx-auto mt-12 md:mt-14 lg:mt-[4.5rem] px-[1.5rem] md:px-[2.1rem] lg:px-[4rem] 2xl:px-0'>
