...
const Header = () => {
    ...
    return (
        <section>
            {/* Desktop Navbar */}
            <header className="bg-red-600 my-nav w-full fixed top-0 left-0 z-[1000] transition-all duration-[.6s]">
                <nav className="bg-transparent z-[1000] mx-auto max-w-[82rem] flex justify-between py-5 items-center top-0 left-0 w-full transition duration-[.6s] px-[1.5rem] md:px-[1rem] lg:px-[4rem] xl:px-[4rem] 2xl:px-0">
                    <div className="text-[2rem] xl:text-[2.5rem] font-bold tracking-wide cursor-pointer" data-aos="zoom-in" data-aos-duration="1500">
